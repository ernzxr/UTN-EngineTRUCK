...
const TripleLayout: FC<Record<string, never>> = function () {
    return (
        <div className="flex flex-wrap justify-center xl:justify-between xl:mx-[15%] sm:justify-start mb-[20%] mt-[20%] xl:mt-[10%] xl:mb-[10%]">
            <Card
                className="w-full sm:w-[45%] md:w-[30%] lg:w-[25%] xl:w-[300px] m-2 text-center "
                imgAlt="Meaningful alt text for an image that is not purely decorative"
                imgSrc="MOT_CARD.jpg"
            >
                <h5 className="text-2xl font-raleway font-bold centerw tracking-tight shadow-sm text-gray-900 dark:text-white ">
                    MOTORES
                </h5>
            </Card>
            <Card
