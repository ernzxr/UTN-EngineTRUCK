...
const EngineUpdateModal = () => {
    ...
    const [engineMode, setEngineModel] = useState('');
    ...
    return (
        ...
        {enginesList.map((object: EngineResponse) => (
            ...
            } }>Editar</Button><Modal show={updateModal} size="md" onClose={closeUpdateModal}>
                    <Modal.Header />
                    <Modal.Body>
                        <div className="space-y-6">
                            ...
                            <div>
                                ...
                                <TextInput id="model" type="text" placeholder='Ingrese el Modelo del Motor' value={object.model} onChange={(e) => { setEngineModel(e.target.value); } } />
                            </div>
                            <div>
                                <div className="mb-2 block">
