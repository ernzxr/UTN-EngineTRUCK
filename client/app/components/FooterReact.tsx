...
const FooterReact = () => {
  return (
    <Footer container>
      <Footer.Copyright href="/" by="EngineTRUCK" className="text-blue-800 mb-5 xl:mb-1" />
      <Footer.LinkGroup className="flex items-center space-x-2 xl:mt-[5px] text-blue-800 font-bold mb-5 xl:mb-1 xl:space-x-9">
      ...
      <div className="flex items-center space-x-10 xl:space-x-9 xl:mt-[5px] mb-5 xl:mb-1 ">
